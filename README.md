...
- **コンポーネント分割**: 再利用可能な粒度でコンポーネントを設計（`Sidebar`, `SidebarItem`, `Main`, `Icons`）
...
2. **楽観的UI更新**: 保存前に一時的に状態を反映し、UXを向上
3. **エラーハンドリング**: ネットワークエラーやバリデーションエラーの適切な処理
